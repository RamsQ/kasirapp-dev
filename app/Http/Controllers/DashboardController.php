...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $expiredProducts = Product::whereNotNull('expired_date')
            ...
            ->limit(10) // Batasi 10 agar tidak lemot
            ->get();

        // B. Produk AKAN Kadaluarsa (H-30)
        $expiringProducts = Product::whereNotNull('expired_date')
            ->whereDate('expired_date', '>=', Carbon::now()) // Belum expired
            ->whereDate('expired_date', '<=', Carbon::now()->addDays(30)) // Mepet 30 hari
        ...
        return Inertia::render('Dashboard/Index', [
            ...
            // Kirim data expired ke Frontend
